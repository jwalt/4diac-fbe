...
#include "ROS2_turtlesim__srv__Spawn__Response_gen.cpp"
#endif
...
CIEC_ROS2_turtlesim__srv__Spawn__Response::CIEC_ROS2_turtlesim__srv__Spawn__Response() :
    CIEC_STRUCT(g_nStringIdROS2_turtlesim__srv__Spawn__Response, 1, scmElementTypes, scmElementNames, e_APPLICATION + e_CONSTRUCTED + 1) {
}

const CStringDictionary::TStringId CIEC_ROS2_turtlesim__srv__Spawn__Response::scmElementNames[] = {g_nStringIdname};
const CStringDictionary::TStringId CIEC_ROS2_turtlesim__srv__Spawn__Response::scmElementTypes[] = {g_nStringIdSTRING};
