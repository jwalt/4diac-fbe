...
#include "lms_buffer.hpp"
#include "lms_structs.hpp"
#include <string>
#include <array>
#include <cstdint>
...
class LMS1xx {
  public:
    ...
    /*!
     * @brief Discard all pending data, making sure that the next call fetches fresh data.
     */
    void flush();
  ...
  protected:
    int sendCommand(const char *cmd, std::array<char,100> &buf);
