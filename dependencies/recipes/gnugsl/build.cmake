...
project(GSL LANGUAGES C VERSION 2.6)

set(RUN_RESULT FALSE CACHE BOOL "")
set(GSL_DISABLE_TESTS TRUE CACHE BOOL "")
...
if (GSL_INSTALL OR NOT DEFINED GSL_INSTALL)
  if (MSVC AND GSL_INSTALL_MULTI_CONFIG)
    foreach(config ${CMAKE_CONFIGURATION_TYPES})
      install(TARGETS gsl gslcblas EXPORT gnu-gsl
