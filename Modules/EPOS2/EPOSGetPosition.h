...
#ifndef _EPOSGETPOSITION_H_
#define _EPOSGETPOSITION_H_
...
class FORTE_EPOSGetPosition: public CFunctionBlock{
...
public:
  FUNCTION_BLOCK_CTOR(FORTE_EPOSGetPosition){
  };

  virtual ~FORTE_EPOSGetPosition(){};
