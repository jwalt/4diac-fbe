...
#ifndef _EPOSGETSPEED_H_
#define _EPOSGETSPEED_H_
...
class FORTE_EPOSGetSpeed: public CFunctionBlock{
...
public:
  FUNCTION_BLOCK_CTOR(FORTE_EPOSGetSpeed){
  };

  virtual ~FORTE_EPOSGetSpeed(){};
